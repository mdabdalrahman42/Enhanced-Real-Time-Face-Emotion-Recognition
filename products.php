                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mb-2 mb-lg-0 start">
                            ...
                            <a class="nav-link text-primary" aria-current="page" href="' . $_SERVER['PHP_SELF'] . '?id=' . $id . '&emotion=' . $emotion . '">Products</a>
...
if ($productResult->num_rows > 0) 
{
                                ...
                                while ($row = $productResult->fetch_assoc()) {
                                    ...
                                    $filename = $row['Product Id'];
                                    $possible_extensions = array("jpg", "jpeg", "png", "webp", "avif");

                                    foreach ($possible_extensions as $extension) {
                                        $file_path = "static/images/Products/". $filename . "." . $extension;
                                    ...
                                    echo '
                                            <div class="col-md-4 mt-4 mb-4 card-container d-flex justify-content-center align-items-center">

                                                <div class="card mx-auto">
                                                
                                                    <img src="static/images/Products/'. $row['Product Id'] . '.' . $ext .'" height="320px" class="card-img-top border-bottom border-body-tertiary" alt="...">
                                                    ...
                                                    <div class="card-body d-flex flex-column justify-content-center">
                                                        ...
                                                        <p class="card-text text-center cost mb-2">'. $row['Price'] . '</p>
